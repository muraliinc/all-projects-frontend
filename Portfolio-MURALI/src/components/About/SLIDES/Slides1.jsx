    ...
    <div className='slide-main-container'>
        <div className='slide-inside-container'>
         <p className="text-1 white-text" > <span className="yellow-text"> I'M</span>  MURALI</p>
             ...
             <li className='yellow-text'>From <span className="white-text">sales,</span> I learned how people think</li> 
              <li className='yellow-text'>From <span className="white-text">boxing,</span> I learned how to stay relentless.</li> 
                </ul>   
            ...
            <img className="bottom-batman logo" src={batman_logo_icon} alt="batman-logo"/>
      </div>
    </div> 
  )
}
