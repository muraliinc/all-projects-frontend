  ...
  return (
    <section className='footer-section'> 
       <span className='bottom-tag-line'></span>
        ...
        <div className="footer-containe1">
          <img className='footer-logo' src={footer_icon} alt="footer-logo" />
          <div className="bottom-menu-items">
            <p className='footer-title white-text'>menu</p>
            <ul className='footer-list'>
              <li onClick={()=>scrollToSection("#HOME")} className='white-text'>home</li>
              <li onClick={()=>scrollToSection("#ABOUT")}  className='white-text'>ABOUT</li>
              <li onClick={()=>scrollToSection("#PROJECT")} className='white-text'>PROJECTS</li>
              <li onClick={()=>scrollToSection("#SKILLS")} className='white-text'>SKILLS</li>
